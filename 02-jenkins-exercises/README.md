...
Your team members want to collaborate on your Node.js application, where you list developers with their associated projects. So they ask you to set up a git repository for it.
...
3. Create a pipeline job in the Jenkins UI. Do the following configuration:
   ...
   2. Set the repo to check out from GitHub:
